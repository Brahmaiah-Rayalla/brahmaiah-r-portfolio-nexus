    ...
    <section className="py-20 px-6 bg-gradient-to-r from-[#1a1a2e]/30 to-[#16213e]/30">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center">
            <div className="relative mb-6">
              <div className="w-24 h-24 mx-auto bg-gradient-to-br from-[#00BFFF] to-[#8A2BE2] rounded-full flex items-center justify-center shadow-[0_0_50px_rgba(0,191,255,0.3)]">
            ...
            <h3 className="text-xl font-semibold text-[#00BFFF] mb-2">OpenShift & Kubernetes</h3>
          ...
          <div className="text-center">
            <div className="relative mb-6">
              <div className="w-24 h-24 mx-auto bg-gradient-to-br from-[#8A2BE2] to-[#00BFFF] rounded-full flex items-center justify-center shadow-[0_0_50px_rgba(138,43,226,0.3)]">
            ...
            <h3 className="text-xl font-semibold text-[#8A2BE2] mb-2">Cost Reduction</h3>
          ...
          <div className="text-center">
            <div className="relative mb-6">
              <div className="w-24 h-24 mx-auto bg-gradient-to-br from-[#00CED1] to-[#FF6B6B] rounded-full flex items-center justify-center shadow-[0_0_50px_rgba(0,206,209,0.3)]">
            ...
            <h3 className="text-xl font-semibold text-[#00CED1] mb-2">Cloud Microservices</h3>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-gradient-to-r from-[#00BFFF]/10 to-[#8A2BE2]/10 p-8 rounded-2xl border border-[#00BFFF]/20">
          ...
          <div className="bg-gradient-to-r from-[#8A2BE2]/10 to-[#00BFFF]/10 p-8 rounded-2xl border border-[#8A2BE2]/20">
