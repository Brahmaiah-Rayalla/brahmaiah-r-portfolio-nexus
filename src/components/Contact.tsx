...
export const Contact = () => {
  ...
  return (
    <section id="contact" className="py-20 px-6 bg-gradient-to-r from-[#1a1a2e]/30 to-[#16213e]/30">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button 
              ...
              className="w-full bg-gradient-to-r from-[#00BFFF] to-[#8A2BE2] hover:from-[#8A2BE2] hover:to-[#00BFFF] text-white border-0 shadow-[0_0_20px_rgba(0,191,255,0.5)] disabled:opacity-50"
            >
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <button 
                ...
                className="flex items-center space-x-3 text-gray-300 hover:text-[#00BFFF] transition-colors duration-300 cursor-pointer"
              >
