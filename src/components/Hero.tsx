...
export const Hero = () => {
  ...
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        <div className="mb-8">
          <h1 className="text-6xl md:text-8xl font-bold mb-4 bg-gradient-to-r from-[#00BFFF] to-[#8A2BE2] bg-clip-text text-transparent animate-fade-in">Brahmaiah Rayalla</h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button size="lg" onClick={handleDownloadResume} className="bg-gradient-to-r from-[#00BFFF] to-[#8A2BE2] hover:from-[#8A2BE2] hover:to-[#00BFFF] text-white border-0 shadow-[0_0_20px_rgba(0,191,255,0.5)] hover:shadow-[0_0_30px_rgba(138,43,226,0.7)] transition-all duration-300">
            <Download className="w-5 h-5 mr-2" />
            Download Resume
          </Button>
          <Button size="lg" variant="outline" onClick={handleContactClick} className="border-[#00BFFF] text-[#00BFFF] hover:bg-[#00BFFF] hover:text-[#121212] shadow-[0_0_20px_rgba(0,191,255,0.3)] transition-all duration-300">
