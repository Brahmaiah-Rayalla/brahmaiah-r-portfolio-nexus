      ...
      <div className="text-center">
        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="flex-1 text-left">
            ...
            <p className="text-lg text-gray-300 leading-relaxed mb-6">With 13+ years of experience spearheading enterprise-level Java solutions, I am a Solutions Architect dedicated to building the resilient, scalable, and high-performance systems that power modern business. I excel at leading the entire architectural lifecycle, from strategic design and technology selection to hands-on implementation and performance tuning.  My mission is to translate complex business requirements into elegant technical roadmaps that deliver measurable results.  My core expertise lies in:  Cloud-Native Architecture: Designing and deploying distributed systems on OpenShift, PCF, GCP, and AWS, leveraging Kubernetes for orchestration and Docker for containerization. I have successfully led migrations from on-premise data centers to the cloud, resulting in a ~30% reduction in TCO for key applications.  Microservices & API Design: Architecting secure, decoupled microservices using Spring Boot and Quarkus, interconnected via RESTful APIs and event-driven patterns with Apache Kafka or RabbitMQ. My focus on Domain-Driven Design (DDD) ensures solutions are aligned with business domains.  Performance & Resilience: Proactively identifying and resolving system bottlenecks through advanced performance tuning, load testing, and implementing observability stacks (ElasticAPM, Splunk Observability Cloud(SPOC) and BlazeMeter). I design for failure, building self-healing systems that achieve and maintain 99.99% uptime.  DevOps & Automation: Championing a culture of automation by building robust CI/CD pipelines (Jenkins, GitHub Actions) and employing Infrastructure as Code (Harness) to ensure rapid, reliable, and repeatable deployments.</p>
